...
export default function SeatManagementPage() {
  ...
  const getSeatColor = (seat: SeatWithRegistration) => {
    ...
    if (seat.status === 'selected') {
      return 'bg-yellow-400 cursor-pointer'
    }
        ...
        if (seatIndex < seats.length) {
          ...
          rowSeats.push(
            <button
              ...
              className={`w-14 h-14 rounded-md text-white font-semibold text-sm transition-all ${getSeatColor(seat)} hover:opacity-80 ${
    ...
    <div className="min-h-screen bg-stripes md:bg-stripes-desktop text-black py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <div className="mb-8 flex justify-between items-center">
          <div>
            <h1 className="text-3xl font-bold text-black">Quản lý Ghế Ngồi</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 bg-white rounded-md border border-gray-200 p-6">
            <h2 className="text-xl font-semibold text-black mb-4">Sơ đồ Ghế</h2>
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-white rounded-md border border-gray-200 p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-black">{seats.length}</p>
              </div>
          ...
          <div className="bg-white rounded-md border border-gray-200 p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-600">Ghế trống</p>
      ...
      {showAssignModal && selectedSeat && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="bg-white rounded-md border border-gray-200 max-w-md w-full mx-4 animate-zoom-in">
            <div className="p-6">
                ...
                {registrations.length === 0 ? (
                  ...
                  registrations.map(reg => (
                    <button
                      ...
                      className="w-full text-left p-3 border border-gray-200 rounded-md hover:bg-gray-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                    >
